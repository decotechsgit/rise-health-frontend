...
const Feed = () => {
  return (
    <Row className="w-full flex-col gap-4 rounded-2xl bg-white p-6">
      <Row className="flex-col gap-3">
        <TextElement as="h3">Information Hub</TextElement>

        <TextElement as="p">
          Stay informed with the latest updates, articles, and news. Explore
          important insights, policy changes, and helpful resources to stay up
          to date.
        </TextElement>
      </Row>
