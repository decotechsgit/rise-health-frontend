...
import GroupSelectItem
  from "@components/pages/dashboard/onboarding/main-content/onboaring-step-content/GroupSelectItem";
...
const OnboardingContent = ({
  ...
  return (
    <div className="flex w-full flex-wrap overflow-y-hidden">
      <TextElement as="h1" className="w-full !font-normal !text-[20px] sm:!text-[28px] lg:!text-[35px]">
        <div dangerouslySetInnerHTML={{ __html: onboardingStepTitle }} />
      </TextElement>

      <section className="w-auto lg:min-h-[64vh] overflow-x-hidden overflow-y-hidden p-2 pb-40 lg:mt-4 lg:w-2/3">
