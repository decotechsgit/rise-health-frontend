...
const FileUploadItem = ({ step, stepKey }: FileUploadItemProps) => {
  ...
  const title = step.title ? DOMPurify.sanitize(step.title) : null;
  ...
  const handleFiles = async (files: FileList | null) => {
    ...
    try {
      const uploadedFilesResponse =
        await mediaService.uploadMultipleFiles(formData);
        ...
        <div>
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <TextElement
                as="p"
                className={`${altform.className} text-[#535353]`}
              >
                Drag and Drop or{" "}
                <TextElement
                  as="span"
              ...
              <TextElement
                as="p"
                className={`${altform.className} text-[#8C8C8C]`}
              >
